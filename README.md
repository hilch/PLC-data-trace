...
![csvsample](https://github.com/hilch/PLC-data-trace/blob/AS4X/doc/ScreenshotSampleData.PNG)
...
# Visualize data
use Microsoft Excel, [Libre Office Calc](https://de.libreoffice.org/discover/calc/) or [just use Python](https://github.com/hilch/PLC-data-trace/tree/AS4X/python) to visualize data.
...
![sample.png](https://github.com/hilch/PLC-data-trace/blob/AS4X/doc/sample.png)
